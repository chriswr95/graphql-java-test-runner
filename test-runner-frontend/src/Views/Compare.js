  ...
  switch (action.type) {
    ...
    case 'setClassesAndBenchmarksState':
      return {
        ...
        combinedClassesAndBenchmarksState: combineChartsData(
          buildChartsData(action.payload.testRunA),
          buildChartsData(action.payload.testRunB)
        ),
      };
    case 'handleSnackBar':
      return {
        ...
        <div>
          ...
          >
            <TabContext value={value}>
              ...
              <Box sx={{ position: 'absolute', right: 0, bottom: 0, width: '54%', borderRadius: '12px 0 0 0', borderLeft: '1.5px solid #e535ab', borderTop: '1.5px solid #e535ab', paddingBottom: '1%' }}>
                  <TabList style={{color:'gray'}}onChange={handleChange} TabIndicatorProps={{style: {background:'#e535ab' }}} >
                    <Tab label="Test Run 1" value="1" />
                    <Tab label="Test Run 2" value="2" />
                  </TabList>
                </Box>
